/*CREATE TABLE IF NOT EXISTS USERS (ID SERIAL NOT NULL, NIF VARCHAR(10), NAME VARCHAR(255) NOT NULL, SURNAME VARCHAR(255) NOT NULL, PHONE VARCHAR(255), LOGIN VARCHAR(255) NOT NULL UNIQUE, PASSWORD VARCHAR(255),
